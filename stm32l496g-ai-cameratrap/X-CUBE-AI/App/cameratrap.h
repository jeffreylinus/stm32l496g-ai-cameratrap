/**
  ...
  ******************************************************************************
  */
#ifndef AI_CAMERATRAP_H
#define AI_CAMERATRAP_H

#include "cameratrap_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CAMERATRAP_MODEL_NAME          "cameratrap"
#define AI_CAMERATRAP_ORIGIN_MODEL_NAME   "localizer_160x120_int8"

/******************************************************************************/
#define AI_CAMERATRAP_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CAMERATRAP_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CAMERATRAP_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CAMERATRAP_IN_NUM        (1)

AI_DEPRECATED
#define AI_CAMERATRAP_IN \
  ai_cameratrap_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAMERATRAP_IN_SIZE { \
  AI_CAMERATRAP_IN_1_SIZE, \
}
#define AI_CAMERATRAP_IN_SIZE_BYTES { \
  AI_CAMERATRAP_IN_1_SIZE_BYTES, \
}
#define AI_CAMERATRAP_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_CAMERATRAP_IN_1_HEIGHT      (160)
#define AI_CAMERATRAP_IN_1_WIDTH       (120)
#define AI_CAMERATRAP_IN_1_CHANNEL     (1)
#define AI_CAMERATRAP_IN_1_SIZE        (19200)
#define AI_CAMERATRAP_IN_1_SIZE_BYTES  (19200)

/******************************************************************************/
#define AI_CAMERATRAP_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CAMERATRAP_OUT \
  ai_cameratrap_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAMERATRAP_OUT_SIZE { \
  AI_CAMERATRAP_OUT_1_SIZE, \
}
#define AI_CAMERATRAP_OUT_SIZE_BYTES { \
  AI_CAMERATRAP_OUT_1_SIZE_BYTES, \
}
#define AI_CAMERATRAP_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_CAMERATRAP_OUT_1_CHANNEL     (4)
#define AI_CAMERATRAP_OUT_1_SIZE        (4)
#define AI_CAMERATRAP_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CAMERATRAP_N_NODES (27)
 ...
 * @ref ai_cameratrap_create. Both the activations memory buffer 
 ...
 * using @ref ai_cameratrap_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cameratrap_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cameratrap_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CAMERATRAP_*
 * defines into file @ref cameratrap.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cameratrap_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CAMERATRAP_H */
